...
import { User, LogOut, ChevronRight, Settings, BellRing } from "lucide-react"
  ...
  return (
    <div className="flex flex-col h-full bg-[#f8fafc]">
      <div className="bg-white px-4 py-6 border-b border-gray-100 flex flex-col items-center justify-center pt-10">
        <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-[var(--color-primary)] shadow-md mb-4 bg-gray-200 flex items-center justify-center">
          {user?.photoURL ? (
        ...
        <h1 className="text-xl font-bold text-gray-900">{user?.displayName || "Profissional"}</h1>
        <span className="text-xs font-bold bg-purple-100 text-purple-700 px-2 py-1 rounded-md mt-1">Funcionário</span>
      </div>
      ...
      <div className="p-4 pb-24 space-y-4">
        ...
        <div className="bg-[var(--color-primary)] text-white p-4 rounded-2xl shadow-lg flex flex-col gap-2 mt-4 relative overflow-hidden">
          ...
          <h3 className="font-bold text-lg flex items-center gap-2"><BellRing className="w-5 h-5" /> Receba alertas de novos agendamentos</h3>
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
          <button className="w-full flex items-center justify-between p-4 border-b border-gray-50 hover:bg-gray-50 active:bg-gray-100 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="font-bold text-gray-900 text-sm">Meus Dados</p>
          ...
          <button className="w-full flex items-center justify-between p-4 border-b border-gray-50 hover:bg-gray-50 active:bg-gray-100 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="font-bold text-gray-900 text-sm">Configurações</p>
                <p className="text-xs text-gray-500">Notificações e preferências</p>
              </div>
            </div>
            <ChevronRight className="w-5 h-5 text-gray-300" />
          </button>
